import{d as t,j as e}from"./index-B9J805j2.js";const a="var(--card, #111)",s="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",o="var(--border, #222)",i="var(--accent, #22c55e)",l="var(--danger, #ef4444)",c="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",r={Page:t.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${a};
