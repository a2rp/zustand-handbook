import{d as s,j as e}from"./index-ltRhJ8RM.js";const i="var(--card, #111)",r="var(--text, #e9e9e9)",a="var(--muted, #b7b7b7)",o="var(--border, #222)",d="var(--accent, #22c55e)",n="var(--danger, #ef4444)",l="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${i};
