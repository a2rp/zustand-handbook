import{d as s,j as e}from"./index-B9J805j2.js";const a="var(--card, #111)",o="var(--text, #e9e9e9)",i="var(--muted, #b7b7b7)",r="var(--border, #222)",n="var(--accent, #22c55e)",c="var(--danger, #ef4444)",l="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${a};
