import{d as t,j as e}from"./index-CpvfKB5t.js";const n="var(--card, #111)",o="var(--text, #e9e9e9)",i="var(--muted, #b7b7b7)",r="var(--border, #222)",d="var(--accent, #22c55e)",c="var(--danger, #ef4444)",a="var(--radius, 16px)",l="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:t.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${n};
