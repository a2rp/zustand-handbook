import{d as r,j as e}from"./index-CpvfKB5t.js";const s="var(--card, #111)",i="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",o="var(--border, #222)",a="var(--accent, #22c55e)",l="var(--danger, #ef4444)",d="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:r.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${s};
