import{d as o,j as e}from"./index-ltRhJ8RM.js";const s="var(--card, #111)",r="var(--text, #e9e9e9)",c="var(--muted, #b7b7b7)",t="var(--border, #222)",a="var(--accent, #22c55e)",i="var(--danger, #ef4444)",d="var(--radius, 16px)",l="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",n={Page:o.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${s};
