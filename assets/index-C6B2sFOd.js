import{d as n,j as e,N as t}from"./index-CpvfKB5t.js";const o="var(--card, #111)",a="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",r="var(--border, #222)",i="var(--accent, #22c55e)",d="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:n.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${o};
