import{j as e}from"./index-Bmr0gcqO.js";import{S as s}from"./styled-Bj7slSHo.js";const a=()=>e.jsxs(s.Page,{children:[e.jsx(s.Title,{children:"Async Patterns — Loading, Error, Optimistic"}),e.jsx(s.Subtitle,{children:"Practical patterns I use for network calls and side-effects with Zustand."}),e.jsxs(s.Section,{children:[e.jsx("h3",{children:"My go-to slice shape"}),e.jsx("pre",{className:"good",children:`import { create } from 'zustand';
