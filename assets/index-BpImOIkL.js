import{d as r,j as e}from"./index-CpvfKB5t.js";const o="var(--card, #111)",n="var(--text, #e9e9e9)",i="var(--muted, #b7b7b7)",t="var(--border, #222)",c="var(--accent, #22c55e)",d="var(--danger, #ef4444)",a="var(--radius, 16px)",l="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:r.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${o};
