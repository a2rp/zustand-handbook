import{d as t,j as e}from"./index-Gt8sd0pi.js";const r="var(--card, #111)",i="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",s="var(--border, #222)",n="var(--accent, #22c55e)",d="var(--danger, #ef4444)",a="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",o={Page:t.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${r};
