import{d as s,j as e}from"./index-B9J805j2.js";const r="var(--card, #111)",t="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",n="var(--border, #222)",a="var(--accent, #22c55e)",i="var(--danger, #ef4444)",d="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",o={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${r};
