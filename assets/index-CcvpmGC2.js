import{d as s,j as e}from"./index-CpvfKB5t.js";const r="var(--card, #111)",a="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",o="var(--border, #222)",i="var(--accent, #22c55e)",d="var(--danger, #ef4444)",c="var(--radius, 16px)",l="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${r};
