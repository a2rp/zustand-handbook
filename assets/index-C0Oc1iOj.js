import{d as t,j as e}from"./index-Gt8sd0pi.js";const o="var(--card, #111)",r="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",a="var(--border, #222)",i="var(--accent, #22c55e)",l="var(--danger, #ef4444)",d="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:t.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${o};
