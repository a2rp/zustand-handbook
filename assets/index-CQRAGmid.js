import{d as o,j as e}from"./index-ltRhJ8RM.js";const r="var(--card, #111)",n="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",t="var(--border, #222)",d="var(--accent, #22c55e)",i="var(--danger, #ef4444)",c="var(--radius, 16px)",a="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:o.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${r};
