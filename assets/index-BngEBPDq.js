import{d as s,j as e}from"./index-ltRhJ8RM.js";const o="var(--card, #111)",n="var(--text, #e9e9e9)",a="var(--muted, #b7b7b7)",t="var(--border, #222)",l="var(--accent, #22c55e)",c="var(--danger, #ef4444)",i="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",r={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${o};
