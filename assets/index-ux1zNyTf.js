import{d as r,j as e}from"./index-B9J805j2.js";const a="var(--card, #111)",i="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",s="var(--border, #222)",o="var(--accent, #22c55e)",d="var(--danger, #ef4444)",c="var(--radius, 16px)",l="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:r.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${a};
