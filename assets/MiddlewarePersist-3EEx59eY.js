import{j as e}from"./index-Gt8sd0pi.js";import{S as s}from"./styled-B1sUtMju.js";const a=()=>e.jsxs(s.Page,{children:[e.jsx(s.Title,{children:"Middleware: persist"}),e.jsx(s.Subtitle,{children:"Save parts of the store to storage so state survives refresh and app restarts."}),e.jsxs(s.Section,{children:[e.jsx("h3",{children:"Why I use it"}),e.jsxs("ul",{children:[e.jsx("li",{children:"Keep user choices across refresh (theme, filters, sort, cart)."}),e.jsx("li",{children:"Restore session after a crash or reload."}),e.jsx("li",{children:"Version + migrate data safely as the app evolves."})]})]}),e.jsxs(s.Section,{children:[e.jsx("h3",{children:"Basic setup"}),e.jsx("pre",{className:"good",children:`// stores/theme.js
