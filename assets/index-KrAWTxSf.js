import{d as o,r as c,j as t,N as y}from"./index-CpvfKB5t.js";const j="var(--card, #111)",g="var(--text, #e9e9e9)",l="var(--muted, #b7b7b7)",d="var(--border, #222)",k="var(--accent, #22c55e)",$="var(--radius, 16px)",S="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",i={Page:o.div`
        width: 100%;
        max-width: 1100px;
        margin: 0 auto;
        background: ${j};
