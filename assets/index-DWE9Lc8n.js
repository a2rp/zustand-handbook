import{d as r,j as e}from"./index-B9J805j2.js";const o="var(--card, #111)",i="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",t="var(--border, #222)",c="var(--accent, #22c55e)",a="var(--danger, #ef4444)",l="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:r.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${o};
