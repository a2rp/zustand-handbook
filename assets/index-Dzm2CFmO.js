import{d as o,j as e}from"./index-Bmr0gcqO.js";const t="var(--card, #111)",i="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",r="var(--border, #222)",c="var(--accent, #22c55e)",l="var(--danger, #ef4444)",a="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:o.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${t};
