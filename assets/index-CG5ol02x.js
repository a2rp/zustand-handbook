import{d as i,j as e}from"./index-ltRhJ8RM.js";const r="var(--card, #111)",a="var(--text, #e9e9e9)",n="var(--muted, #b7b7b7)",s="var(--border, #222)",o="var(--accent, #22c55e)",l="var(--danger, #ef4444)",d="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:i.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${r};
