import{d as s,j as e}from"./index-CpvfKB5t.js";const o="var(--card, #111)",r="var(--text, #e9e9e9)",i="var(--muted, #b7b7b7)",a="var(--border, #222)",l="var(--accent, #22c55e)",n="var(--danger, #ef4444)",c="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",t={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${o};
