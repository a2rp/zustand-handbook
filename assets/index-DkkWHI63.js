import{d as s,j as e}from"./index-Bmr0gcqO.js";const n="var(--card, #111)",t="var(--text, #e9e9e9)",i="var(--muted, #b7b7b7)",l="var(--border, #222)",d="var(--accent, #22c55e)",r="var(--danger, #ef4444)",a="var(--radius, 16px)",c="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",o={Page:s.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${n};
