import{d as t,j as e}from"./index-Gt8sd0pi.js";const i="var(--card, #111)",a="var(--text, #e9e9e9)",o="var(--muted, #b7b7b7)",r="var(--border, #222)",l="var(--accent, #22c55e)",n="var(--danger, #ef4444)",c="var(--radius, 16px)",d="var(--shadow, 0 8px 24px rgba(0,0,0,0.35))",s={Page:t.div`
        width: 100%;
        max-width: 1000px;
        margin: 0 auto;
        background: ${i};
